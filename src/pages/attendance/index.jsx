...
const Attendance = () => {
  const [students, setStudents] = useState([
    ...
    { id: 3, name: 'Charlie K.', timeLeft: 2, avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop', selected: true, low: true },
    { id: 4, name: 'Diana P.', timeLeft: 15, avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop', selected: false },
    { id: 5, name: 'Evan R.', timeLeft: 3, avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop', selected: true, low: true },
    { id: 6, name: 'Fiona G.', timeLeft: 12, avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop', selected: false },
    { id: 7, name: 'George H.', timeLeft: 20, avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop', selected: false },
  ])
